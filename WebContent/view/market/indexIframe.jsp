...
<link href="/Agile/view/market/styleBody/style.css" rel="stylesheet"
	type="text/css" />
</head>
<body>
		...
		<article class="U-article">
			<section class="usercenter">
				...
				<div class="U-header MT20 Overflow">
					...
					<br>
					<br>
					<p class="Font12 CorRed FontW" style="font-size: 14px;">我的积分:&nbsp;&nbsp;<%=userinfo.getUsercredit() %></p>
				</div>
			</section>
		</article>
	</div>
	<div class="myHeader">
		<iframe id="optionrecord" name="optionrecord" src="/Agile/AlreadyExchangeServlet" style="overflow: visible;"
