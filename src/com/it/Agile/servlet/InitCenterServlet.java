...
@WebServlet("/InitCenterServlet")
public class InitCenterServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("view/center/indexIframe.jsp").forward(request, response);
	}
